...
public class NewAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        procSpinner = findViewById(R.id.appointment_procedure_spinner);
    ...
    public void onSaveAppointmentButtonClick() {
        ...
        String procedure = procSpinner.getSelectedItem().toString();

        // Create a new appointment object
        Appointment newAppointment = new Appointment(date, time, procedure);
